...
xhr.onreadystatechange = function (e) {
  ...
  if (xhr.readyState === XMLHttpRequest.DONE) {
	...
	playerid = htmlDoc.getElementById("mcid").value;
    } else {
      console.log('Error!');
    }
  }
...
Blockly.JavaScript['onchat'] = function(block) { /* 채팅명령어 */
	...
	var code = "\
command( '" + playerid + "_" + value_command.replace(/'/g,"") + "', function ( parameters, player ) {\n\
...
Blockly.JavaScript['directforward'] = function(block) { /* 숫자만큼 앞으로 이동 명령어 */
  var value_command = Blockly.JavaScript.valueToCode(block, 'command', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = "command( '"+playerid + "_"+value_command.replace(/'/g,"")+"', function ( parameters, player ) {\n\
