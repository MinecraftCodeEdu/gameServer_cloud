var global = this;
command( 'MichelleSong_call_ch', function ( parameters, player ) {
...
events.entityDeath( function( event ) {
  ...
  var playerId = player.name;
  if( MichelleSong == playerId ) {
    if( event.getEntity().getType() == 'PIG' ) {
  var animal_type = global.theDrone.getLocation().world.spawnEntity(global.theDrone.getLocation(), org.bukkit.entity.EntityType.SHEEP);
  animal_type.setAdult();
  if(animal_type=='CraftHorse{variant=HORSE, owner=null}'){animal_type.setTamed(true);}
  if(false){
    try{
...
events.entityDeath( function( event ) {
  ...
  var playerId = player.name;
  if( MichelleSong == playerId ) {
    if( event.getEntity().getType() == 'SHEEP' ) {
  var animal_type = global.theDrone.getLocation().world.spawnEntity(global.theDrone.getLocation(), org.bukkit.entity.EntityType.WOLF);
  animal_type.setAdult();
  if(animal_type=='CraftHorse{variant=HORSE, owner=null}'){animal_type.setTamed(true);}
  if(false){
    try{
...
events.entityDeath( function( event ) {
  ...
  var playerId = player.name;
  if( MichelleSong == playerId ) {
    if( event.getEntity().getType() == 'WOLF' ) {
  var animal_type = global.theDrone.getLocation().world.spawnEntity(global.theDrone.getLocation(), org.bukkit.entity.EntityType.HORSE);
  animal_type.setAdult();
  if(animal_type=='CraftHorse{variant=HORSE, owner=null}'){animal_type.setTamed(true);}
  if(true){
    try{
...
events.entityDeath( function( event ) {
  ...
  var playerId = player.name;
  if( MichelleSong == playerId ) {
    if( event.getEntity().getType() == 'HORSE' ) {
  var animal_type = global.theDrone.getLocation().world.spawnEntity(global.theDrone.getLocation(), org.bukkit.entity.EntityType.CHICKEN);
  animal_type.setAdult();
  if(animal_type=='CraftHorse{variant=HORSE, owner=null}'){animal_type.setTamed(true);}
  if(true){
